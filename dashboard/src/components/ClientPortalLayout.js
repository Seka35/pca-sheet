  ...
  return (
    <div className="layout-wrapper">
      ...
      <aside style={{
        ...
        {/* Logo */}
        <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
          <img src="/PCA-white.png" alt="PCA" style={{ height: '320px' }} />
          <p style={{ color: 'var(--primary-accent)', fontSize: '11px', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase' }}>
            Client Portal
          </p>
        </div>
      ...
      <main style={{
        ...
        <header style={{
          ...
          <img src="/PCA-white.png" alt="PCA" style={{ height: '144px', margin: '0 auto' }} />
        </header>
