  ...
  return (
    <aside style={{
      ...
      <nav style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        {hasPermission('read_clients') && (
          <Link href="/clients/products" style={getLinkStyle('/clients/products')} onClick={handleLinkClick}>
        ...
        {hasPermission('read_users') && (
          <Link href="/admin/referral-partners" style={getLinkStyle('/admin/referral-partners')} onClick={handleLinkClick}>
